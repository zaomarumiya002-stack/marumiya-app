...
def load_master() -> pd.DataFrame:
    ...
    if df.empty:
        ...
        rows =[{"大カテゴリ": cat, "製品名": p, "初期在庫数": 0} for cat, products in default_products.items() for p in products]
...
def load_customers() -> pd.DataFrame:
    ...
    if df.empty:
        raw_cust =[("㈱ショクカイ", "しょくかい"), ("㈱大黒屋商店", "だいこくやしょうてん"), ("(有)かねこ食品工業", "かねこしょくひんこうぎょう"),("三幸食品㈱", "さんこうしょくひん"), ("㈱石田食品販売", "いしだしょくひんはんばい"), ("松田産業㈱仙台営業所", "まつださんぎょうせんだいえいぎょうしょ"),("㈱ピアット", "ぴあっと"), ("太平物産", "たいへいぶっさん"), ("大阪太平", "おおさかたいへい"),("半田商店", "はんだしょうてん"), ("富山栄養", "とやまえいよう"), ("千葉ｺｰﾌﾟ", "ちばこーぷ"),("日栄物産㈱", "にちえいぶっさん"), ("㈱ｼﾙﾊﾞｰﾗｲﾌ", "しるばーらいふ"), ("神栄㈱", "しんえい"),("㈱ｽｽﾞｶ未来", "すずかみらい"), ("㈱クサマ", "くさま"), ("㈱あさひ食品", "あさひしょくひん"),("㈱山形南生活総合ｾﾝﾀｰ", "やまがたみなみせいかつそうごうせんたー"), ("㈱三和食品", "さんわしょくひん"),("(有)ゆうから", "ゆうから"), ("㈱茨城食品ｶﾞｰﾘｯｸ工業", "いばらきしょくひんがーりっくこうぎょう"),("高瀬物産山形支店", "たかせぶっさんやまがたしてん"), ("高瀬物産㈱弘前支店", "たかせぶっさんひろさきしてん"),("髙瀬物産㈱千葉支店", "たかせぶっさんちばしてん"), ("高瀬物産㈱仙台支店", "たかせぶっさんせんだいしてん"),("髙瀬物産㈱青森支店", "たかせぶっさんあおもりしてん"), ("高瀬物産㈱福島支店", "たかせぶっさんふくしましてん"),("髙瀬物産㈱湘南支店", "たかせぶっさんしょうなんしてん"), ("髙瀬物産㈱練馬支店", "たかせぶっさんねりましてん"),("高瀬物産㈱城東支店", "たかせぶっさんじょうとうしてん"), ("高瀬物産㈱宇都宮支店", "たかせぶっさんうつのみやしてん"),("高瀬物産㈱長野支店", "たかせぶっさんながのしてん"), ("高瀬物産㈱両毛支店", "たかせぶっさんりょうもうしてん"),("高瀬物産㈱三重支店", "たかせぶっさんみえしてん"), ("東海澱粉（株）札幌", "とうかいでんぷんさっぽろ"),("東海澱粉㈱山形営業所", "とうかいでんぷんやまがたえいぎょうしょ"), ("東海澱粉㈱東京支店", "とうかいでんぷんとうきょうしてん"),("東海澱粉㈱福岡", "とうかいでんぷんふくおか"), ("東海澱粉㈱金沢営業所", "とうかいでんぷんかなざわえいぎょうしょ"),("東海澱粉㈱長崎営業", "とうかいでんぷんながさきえいぎょう"), ("ｵｷﾞﾉ食糧株式会社", "おぎのしょくりょう"),("株式会社ﾂｰｴｲﾄ", "つーえいと"), ("㈱ﾏﾙｺ岩村食品団地工場", "まるこいわむらしょくひんだんちこうじょう"),("吉成物産株式会社", "よしなりぶっさん"), ("ｼﾞｰｴﾌｼｰ株式会社", "じーえふしー"),("株式会社ﾆｼﾔﾏ8,020", "にしやま"), ("青和食品株式会社", "せいわしょくひん"),("日進食品株式会社", "にっしんしょくひん"), ("三桜商事株式会社", "さんおうしょうじ"),("石田食品", "いしだしょくひん"), ("三桜商事郡山支店", "さんおうしょうじこおりやましてん"),("ﾏﾙｷｭｰﾌｰｽﾞ株式会社", "まるきゅーふーず"), ("三井物流㈱", "みついぶつりゅう"),("株式会社太堀", "たいぼり"), ("青葉化成株式会社", "あおばかせい"),("青葉化成㈱塩釜営業所", "あおばかせいしおがまえいぎょうしょ"), ("ウジエ仙台", "うじえせんだい"),("株式会社蔵王ﾐｰﾄ", "ざおうみーと"), ("(株)越後ﾊﾑ", "えちごはんむ"),("岩手県学校給食会", "いわてけんがっこうきゅうしょくかい"), ("宮城県学校給食会", "みやぎけんがっこうきゅうしょくかい"),("株式会社ﾏﾙﾄﾓ物産", "まるともぶっさん"), ("ﾕｱｻ･ﾌﾅｼｮｸ株式会社", "ゆあさふなしょく"),("羽黒のうきょう食品加工㈲", "はぐろのうきょうしょくひんかこう"), ("国分北海道株式会社", "こくぶほっかいどう"),("山形県学校給食会", "やまがたけんがっこうきゅうしょくかい"), ("青森県学校給食会", "あおもりけんがっこうきゅうしょくかい"),("㈱ﾗｲﾌﾌﾟﾛﾓｰﾄ", "らいふぷろもーと"), ("株式会社ﾔﾏ食東北営業所", "やましょくとうほくえいぎょうしょ"),("株式会社前川ｲﾝﾀｰﾃｯｸ", "まえかわいんたーてっく"), ("㈱にしむら　庄内支店", "にしむらしょうないしてん"),("㈱にしむら　山形支店", "にしむらやまがたしてん"), ("㈱にしむら　米沢支店", "にしむらよねざわしてん"),("関東砂糖株式会社", "かんとうさとう"), ("国分関信越株式会社", "こくぶかんしんえつ"),("三菱食品株式会社", "みつびししょくひん"), ("東京アグリフーズ", "とうきょうあぐりふーず"),("ｵｲｼｯｸｽ・ﾗ・大地㈱", "おいしっくすらだいち"), ("日興ﾌｰｽﾞ株式会社", "にっこうふーず"),("佐藤株式会社", "さとう"), ("(株)ﾀﾃﾉｺｰﾎﾟﾚｰｼｮﾝ", "たてのこーぽれーしょん"),("国分ﾋﾞｼﾞﾈｽｴｷｽﾊﾟｰﾄ(株)", "こくぶびじねすえきすぱーと"), ("大都魚類株式会社", "だいとぎょるい"),("鳴子観光ﾎﾃﾙ長者原SA(下り線)", "なるこかんこうほてるちょうじゃはら"), ("ｶﾒｲ株式会社", "かめい"),("宮城観光物産", "みやぎかんこうぶっさん"), ("春駒交通㈱", "はるこまこうつう"),("七ヶ宿まちづくり株式会社", "しちかしゅくまちづくり"), ("㈱鬼わさび本舗", "おにわさびほんぽ"),("ｴｺﾌｧｰﾑ蔵王株式会社", "えこふぁーむざおう"), ("まる福㈱", "まるふく"),("宮城県物産振興協会", "みやぎけんぶっさんしんこうきょうかい"), ("株式会社みやぎ蔵王物産", "みやぎざおうぶっさん"),("株式会社仙台百珍味寿や", "せんだいひゃくちんみすや"), ("株式会社カルラ", "かるら")]
...
if page == "📋 受注登録 (出庫)":
    ...
    with tab1:
        ...
        with c1: delivery_date = st.date_input("📅 納品予定日 ＊", value=date.today() + timedelta(days=1), min_value=date.today(), key=f"o_date_{okey}")
        with c2: 
        ...
        if st.button("✅ 受注を登録する", type="primary", use_container_width=True):
            if not selected_cat or not selected_product:
                ...
                save_orders(pd.concat([orders_df, new_row], ignore_index=True))
    ...
    with tab2:
        ...
        if edit_target != "➖ 選択してください":
            ...
            e_cases = ec3.number_input("ケース数", value=target_row["ケース数"], min_value=1)
            ...
            if col_u.button("💾 この内容で更新", type="primary", use_container_width=True):
                ...
                if c_name_edited != "未指定" and c_name_edited not in cust_df["顧客名"].values:
                    ...
                    save_customers(pd.concat([cust_df, new_cust], ignore_index=True))
                idx = orders_df[orders_df["ID"] == edit_target].index[0]
                orders_df.at[idx, "納品予定日"] = pd.Timestamp(e_date)
                orders_df.at[idx, "顧客名"] = c_name_edited
                orders_df.at[idx, "大カテゴリ"] = e_cat
                orders_df.at[idx, "製品名"] = e_prod
                orders_df.at[idx, "ケース数"] = int(e_cases)
                save_orders(orders_df)
                st.rerun()
            if col_d.button("🗑️ このデータを削除", use_container_width=True):
                save_orders(orders_df[orders_df["ID"] != edit_target])
                st.rerun()
        st.markdown('</div>', unsafe_allow_html=True)
    ...
    with tab1:
        ...
        with c1: manu_date = st.date_input("📅 製造予定日 ＊", value=date.today(), min_value=date.today(), key=f"m_date_{mkey}")
        ...
        if st.button("➕ 製造を登録する", type="primary", use_container_width=True):
            if not selected_cat or not selected_product:
                ...
                save_manufactures(pd.concat([manus_df, new_row], ignore_index=True))
    ...
    with tab2:
        ...
        if edit_target != "➖ 選択してください":
            ...
            e_cases = ec2.number_input("製造ケース数", value=target_row["ケース数"], min_value=1)
            ...
            col_u, col_d = st.columns(2)
            if col_u.button("💾 この内容で更新", type="primary", use_container_width=True):
                idx = manus_df[manus_df["ID"] == edit_target].index[0]
                manus_df.at[idx, "製造予定日"] = pd.Timestamp(e_date)
                manus_df.at[idx, "備考"] = e_note.strip()
                manus_df.at[idx, "大カテゴリ"] = e_cat
                manus_df.at[idx, "製品名"] = e_prod
                manus_df.at[idx, "ケース数"] = int(e_cases)
                save_manufactures(manus_df)
                st.rerun()
            if col_d.button("🗑️ このデータを削除", use_container_width=True):
                save_manufactures(manus_df[manus_df["ID"] != edit_target])
                st.rerun()
        st.markdown('</div>', unsafe_allow_html=True)
    ...
    with tab_e:
        ...
        if st.button("💾 製品マスタを保存", type="primary"): save_master(edited_master); st.toast("💾 製品マスタを保存しました", icon="✅"); st.rerun()
        st.markdown('</div>', unsafe_allow_html=True)
    with tab_a:
        ...
        if st.button("➕ 追加する", type="primary"):
            ...
            else: save_master(pd.concat([master_df, pd.DataFrame([{"大カテゴリ": new_cat, "製品名": new_product.strip(), "初期在庫数": int(new_inv)}])], ignore_index=True)); st.toast(f"✅ 追加しました", icon="✅"); st.rerun()
        st.markdown('</div>', unsafe_allow_html=True)
    with tab_d:
        ...
        if del_product and st.button("🗑️ 削除する", type="primary"): save_master(master_df[~((master_df["大カテゴリ"] == del_cat) & (master_df["製品名"] == del_product))]); st.toast(f"🗑️ 削除しました", icon="✅"); st.rerun()
        st.markdown('</div>', unsafe_allow_html=True)
    with tab_c:
        ...
        if st.button("💾 顧客マスタを保存", type="primary"): save_customers(edited_cust); st.toast("💾 顧客マスタを保存しました", icon="✅"); st.rerun()
        st.markdown('</div>', unsafe_allow_html=True)
